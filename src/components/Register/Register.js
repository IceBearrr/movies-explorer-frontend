    ...
    <div className="login-register">
      ...
      <form className="login-register__form"
        ...
        >
          ...
          <input id="name" name="name" type="name" placeholder="" required minLength="2" maxLength="30" value={data.name} onChange={handleChange} />
          <p className="login-register__error-text">
            {/* {errors.name} */}
            </p>
          <p className="placeholder">E-mail</p>
          <input id="email" name="email" type="email" placeholder="" required value={data.email} onChange={handleChange} />
          <p className="login-register__error-text">
            {/* {errors.email} */}
            </p>
          <p className="placeholder">Пароль</p>
          <input id="password" name="password" type="password" placeholder="" required minLength="2" maxLength="20" value={data.password} onChange={handleChange} />
          <p className="login-register__error-text">
            {/* {errors.password} */}
            </p>
