      ...
      <div className="student__info-block">
        <div className="student__info-texts">
          <div className="student__info-text">
            ...
            <p className="student__about">Родился и живу в Москве. Закончил МГТУ им. Н. Э. Баумана. В жизни придерживаюсь двух фраз:
              "В здоровом теле - здоровый дух" и "Человек, который хотя бы отчасти не юморист, – лишь отчасти человек".
              Пиццу и пасту люблю настолько, что в планах фриланс либо удаленная работа в IT-компании с отличным коллективом и видом на море.</p>
          </div>
